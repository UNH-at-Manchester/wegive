...
def survey(reques):
    if request.method == "POST":
        donor_or_charity = request.POST.get('Donor/Charity?')
        interest = request.POST.get('Interest')
        past = request.POST.get('Have you donated before?')
        cause = request.POST.get('What cause did you donate for?')
        reason = request.POST.get('What cause would you like to donate for now?')
    else:
